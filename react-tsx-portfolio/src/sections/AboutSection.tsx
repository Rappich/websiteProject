...
const AboutSection: React.FC = () => {
    ...
    return (
        <section id="about" className="relative pt-[4vh] px-[5%] xl:px-40 min-h-fit xl:h-94vh box-border">
            ...
            <div className="section-container block xl:flex gap-16 xl:h-fit mt-0 xl:mt-8">
                ...
                {/* Details container */}
                <div className="about-details-container flex justify-center flex-col">
