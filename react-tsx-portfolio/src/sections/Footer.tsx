...
const Footer: React.FC = () => {
    ...
    return (
        <footer className="h-[40vh] xl:h-26vh mx-4 flex flex-col justify-center items-center pt-8"> {/* Added padding top */}
            <nav className='h-fit mb-8'>
                <div className="nav-links-container">
                    {/* Apply mobile nav styles base, desktop overrides */}
            ...
            <p className='text-center text-text-primary'>
                Copyright &#169; 2025 Fredrik Rappich. All Rights Reserved. {/* Added copyright */}
            </p>
        </footer>
    );
};
