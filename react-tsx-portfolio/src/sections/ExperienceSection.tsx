...
const ExperienceSection: React.FC = () => {
    ...
    const workExperienceData: TimelineEntry[] = [
        ...
        },
        {
            ...
            description: "As an HR Business partner at Eurenco Bofors AB, I work with our management team to support and guide them in HR-related topics. With an industry that's been under deconstruction for a long time and now is on an uprise, my main task is to act as a project leader with the goal to create, develop & implement new HR strategies within the HR areas: Recruitment, Learning & Development, Onboarding, Performance, co-worker relations, and other areas.",
            listItems: [],
            position: 'right'
        },
        {
            id: 'we3',
            imageSrc: '/assets/tre.jpg',
            title: 'Learning & Development Partner',
            subtitle: 'Tre',
            duration: 'May 2022 - Nov 2022',
            description: 'Contribute to an efficient, effective, and consistent execution of the competence & learning agenda. Mainly working as project lead for a project revolving around a new sales- & service method for Tre. With the end goal to ensure that we had a unitary organization and one way to meet our customers.',
            listItems: [],
            position: 'left'
        },
        {
            id: 'we4',
            imageSrc: '/assets/ikea.jpg',
            title: 'Learning & Delivery Specialist',
            subtitle: 'IKEA',
            duration: 'Jan 2023 - Sep 2024',
            description: 'Contribute to an efficient, effective, and consistent execution of the competence & learning agenda. While developing solutions to ensure delivery on business targets and securing a great customer and co-worker experience.',
            listItems: [
                'Contribute to ensuring that global tools and learning offers are used, keeping the Swedish competence & development offer up to date.',
                'Network with stakeholders across the country organization to best understand and support the delivery of the competence & development agenda.',
                'Develop, optimize, and digitize learning processes & tools for IKEA Sweden, ensuring they meet our ever-changing market.'
            ],
            position: 'right'
        },
        {
            ...
            subtitle: 'IKEA',
            duration: 'Sep 2024 - Current',
            description: 'As an HR Business partner at IKEA Borlänge, I worked together with other functions in the unit to ensure that all HR processes and tools are implemented. By developing and coaching the people in the organization, I contributed to the company\'s growth and set goals.',
            listItems: [
                'Ensure a fluent recruitment process at the unit.',
                'Ensure a fluent recruitment process at the unit.',
                'Develop new routines and collaborations with local business partners to enrich equality, diversity, and inclusion for the store.',
                'Strengthen the leadership at the store.',
                'Enable the Competence & Development agenda for the unit.',
                'Secure health & well-being initiatives.',
                'Support in rehabilitation processes and other co-worker relations-related questions.'
            ],
            position: 'left'
        },
        {
            ...
            title: 'HR Generalist',
            subtitle: 'IKEA',
            duration: 'Jan 2016 - Sep 2024',
            description: 'As an HR Business partner at IKEA Örebro, I worked together with other functions in the unit to ensure that all HR processes and tools are implemented. By developing and coaching the people in the organization, I contributed to the company\'s growth and set goals.',
            listItems: [
                'Ensure a fluent recruitment process at the unit.',
                'Strengthen leadership at the store.',
                'Ensure and execute delivery of learning & training at the unit level.',
                'Enable the Competence & Development agenda for the unit.',
                'Secure health & well-being initiatives.',
            ],
            position: 'right'
